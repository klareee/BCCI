                    ...
                    <tbody class="bg-white divide-y">
                        @forelse($employees as $employee)
                            <tr class="text-gray-700">
                                ...
                                <td class="px-4 py-3 text-sm">
                                    {{ Str::upper($employee->employmentDetail?->position) }}
                                </td>
                                <td class="px-4 py-3 flex gap-4">
                                    <a href="{{ route('employees.show', ['employee' => $employee]) }}" class="relative group text-blue-500">
                                    ...
                                    <a href="{{ route('employees.edit', ['employee' => $employee]) }}" class="relative group text-yellow-500">
                                        <svg xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 24 24"
                                            stroke-width="1.5" stroke="currentColor" class="size-5">
                                            <path stroke-linecap="round" stroke-linejoin="round"
                                    ...
                                    <form action="{{ route('employees.destroy', ['employee'=> $employee]) }}" method="post" onsubmit="return confirm('Do you want to delete this record?')">
                                        @method('DELETE')
                                        @csrf
