                    ...
                    @foreach($leaveTypes as $leaveType)
                        <tr class="text-gray-700">
                            ...
                            <td class="px-4 py-3 flex gap-4">
                                <a href="{{ route('leave-types.edit', ['leave_type' => $leaveType]) }}" class="relative group text-yellow-500">
                                ...
                                <form action="{{ route('leave-types.destroy', ['leave_type' => $leaveType]) }}" method="post" onsubmit="return confirm('Do you want to delete this record?')">
                                    @method('DELETE')
                                    @csrf
