<x-app-layout>
    ...
    <form action="{{ route('leave-types.update') }}" method="POST"
        ...
        <div class="p-4 sm:p-8 bg-white shadow sm:rounded-lg">
            ...
            <div class="max-w-xl mb-4">
                ...
                <x-text-input id="name" name="name" type="text" class="mt-1 block w-full" :value="old('name') ?? $leaveType->name"
            ...
            <div class="max-w-xl mb-4">
                ...
                <select name="is_paid" id="is_paid"
                    ...
                    <option value="paid" @if ($leaveType->is_paid) selected @endif>Paid</option>
                    <option value="not_paid" @if (!$leaveType->is_paid) selected @endif>Not Paid</option>
                </select>
