                    ...
                    <tbody class="bg-white divide-y">
                        @forelse($entries as $entry)
                            <tr class="text-gray-700">
                                ...
                                <td class="px-4 py-3 text-sm">
                                    <button class="flex items-center justify-between px-4 py-2 text-sm font-medium transition-colors duration-150 border border-transparent rounded-lg active:bg-gray-100 hover:bg-gray-200 focus:outline-none focus:ring focus:ring-gray-300">
